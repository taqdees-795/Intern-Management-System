# Task 4 — Resume Builder with PDF Export

## Overview
Dynamic resume builder with live preview, multiple sections, and server-side PDF export via PDFKit.
...
```bash
# Backend
cd backend && npm install && npm run dev   # runs on :5004
